...
object WorkspaceSymbolExtractor {
    private val patterns = listOf(
        Regex("""\b(class|interface|object|data\s+class)\s+([A-Za-z_][A-Za-z0-9_]*)"""),
        Regex("""\b(fun|function|def)\s+([A-Za-z_][A-Za-z0-9_]*)"""),
        Regex("""\b(enum\s+class|type|struct)\s+([A-Za-z_][A-Za-z0-9_]*)"""),
    )
