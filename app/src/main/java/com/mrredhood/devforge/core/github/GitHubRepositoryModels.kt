...
data class GitHubRepository(
    ...
    val visibility: String = if (isPrivate) "private" else "public",
...
data class GitHubRepositoryUpdateRequest(
    ...
    val squashMergeTitle: String,
    val squashMergeMessage: String,
