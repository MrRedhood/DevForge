...
enum class AgentToolId(val wireName: String) {
    ...
    RUN_TEST("run_test"),
    RUN_LINT("run_lint"),
    INSPECT_BUILD_ERROR("inspect_build_error"),
    GET_BUILD_OUTPUT("get_build_output"),
    ...
    GITHUB_GET_ACTIONS("github_get_actions"),
    GITHUB_GET_WORKFLOW_LOGS("github_get_workflow_logs"),
    GITHUB_DISPATCH_WORKFLOW("github_dispatch_workflow"),
