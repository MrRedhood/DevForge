        ...
        Column(Modifier.padding(20.dp)) {
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                Column(Modifier.weight(1f)) {
                    ...
                    Text("Repository detected", color = MaterialTheme.colorScheme.onSurfaceVariant)
                }
            }
        ...
        Column(Modifier.padding(18.dp)) {
            ...
            if (status == null) Text("Waiting for repository observation…", color = MaterialTheme.colorScheme.onSurfaceVariant)
                ...
                Row(horizontalArrangement = Arrangement.spacedBy(18.dp)) {
                    ...
                    ObservationMetric("Hashed", hashed.toString())
    ...
    Card(shape = RoundedCornerShape(22.dp), colors = CardDefaults.cardColors(containerColor = MaterialTheme.colorScheme.surface)) {
        Column(Modifier.padding(18.dp)) {
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                ...
                OutlinedButton(onClick = {}, enabled = false) { Text("Diff") }
