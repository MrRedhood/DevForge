...
@Database(
    entities = [
        ...
        WorkspaceContextLedgerEntity::class,
    ],
    version = 14,
    exportSchema = true,
)
abstract class DevForgeDatabase : RoomDatabase() {
    ...
    abstract fun workspaceContextLedgerDao(): WorkspaceContextLedgerDao
    ...
    companion object {
        ...
        private val MIGRATION_8_9 = object : Migration(8, 9) {
            override fun migrate(database: SupportSQLiteDatabase) {
                database.execSQL("ALTER TABLE agent_tasks ADD COLUMN modelProviderId TEXT")
                database.execSQL("ALTER TABLE agent_tasks ADD COLUMN modelId TEXT")
                database.execSQL("ALTER TABLE agent_tasks ADD COLUMN modelName TEXT")
            }
        }
        ...
        private val MIGRATION_12_13 = object : Migration(12, 13) {
            override fun migrate(database: SupportSQLiteDatabase) {
                database.execSQL("ALTER TABLE chat_messages ADD COLUMN editedAtEpochMs INTEGER")
            }
        }
        ...
        private val MIGRATION_13_14 = object : Migration(13, 14) {
            override fun migrate(database: SupportSQLiteDatabase) {
                database.execSQL("""
                    CREATE TABLE IF NOT EXISTS workspace_context_ledger (
                        workspaceId TEXT NOT NULL PRIMARY KEY,
                        contextVersion INTEGER NOT NULL,
                        recentPathsJson TEXT NOT NULL,
                        lastSnapshot TEXT,
                        updatedAtEpochMs INTEGER NOT NULL
                    )
                """.trimIndent())
