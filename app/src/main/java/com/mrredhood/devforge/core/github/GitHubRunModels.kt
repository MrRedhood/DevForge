...
sealed interface GitHubWorkflowRunsResult {
    data class Success(val runs: List<GitHubWorkflowRun>) : GitHubWorkflowRunsResult
    data class Failure(val message: String) : GitHubWorkflowRunsResult
}
