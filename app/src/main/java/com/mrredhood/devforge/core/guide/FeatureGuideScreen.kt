    ...
    GuideCategory(
        ...
        listOf(
            ...
            t("File preview","Open a workspace file in the editor.",
                ...
                "Workspace tree."),
            t("Editor live preview","Preview the current project directly from the editor play button.",
                listOf(
                    "Tap ▶ in the upper-right editor toolbar.",
                    "Show live preview renders web content and provides a universal source preview for Kotlin, Java, JSON, XML, Markdown, scripts, and other text-based languages without installing an app.",
                    "Show Preview (Build APK) runs the configured Android Debug APK build, displays build logs/errors, downloads the returned APK, opens Android's installer, launches the app after installation, and keeps runtime diagnostics visible.",
                    "Web view preview opens the current web-oriented content in an interactive WebView with JavaScript and DOM storage enabled.",
                    "Live preview refreshes automatically after editor changes.",
                ),
                "Editor → ▶ Preview menu.",
                listOf("live preview = no APK installation","APK preview = build + install + launch + diagnostics","Web view = interactive WebView")),
