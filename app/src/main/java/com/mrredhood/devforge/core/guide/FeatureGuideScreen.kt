...
private val guideCategories = listOf(
    ...
    GuideCategory(
        "Approvals",
        "The common permission system for builds, Git, agents, AI-driven actions, and other side effects.",
        listOf(
    ...
    GuideCategory(
        ...
        listOf(
            ...
            t("AI-managed agent runs","AI can deploy bounded coding agents automatically when a request benefits from parallel or specialized work. Agents are fully AI-controlled from the user perspective.",
                ...
                "AI Chat → live agent run panel; More → AI & GitHub → AI Run Inspector.",
...
t("Agent plans & activity","Chat shows the top-level engineering plan plus each agent's detailed search and execution steps.",
    ...
    GuideCategory(
        ...
        listOf(
            ...
            t("Recovery and persistence","DevForge keeps bounded editor snapshots, durable agent/AI-driven action state, build receipts, and recovery paths.",
                listOf(
