        ...
        listOf(
            ...
            t("Editor live preview","Open the live preview directly from the editor.",
                listOf(
                    ...
                    "If no preview target exists, use Choose to select any workspace file without opening it as an editor tab.",
                    "The preview target is independent from the active editor tab: switching, opening, closing, or editing another editor file does not replace the selected preview target.",
                    "The selected preview target updates automatically when that same file changes, even when it is not the active editor tab.",
                ...
                "Editor → ▶ Preview.",
                listOf("one preview mode","no APK installation","automatic refresh")),
