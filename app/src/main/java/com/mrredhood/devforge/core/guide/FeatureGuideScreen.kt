...
private val guideCategories = listOf(
            ...
            t("AI Tools","Enable bounded tools that any DevForge AI model can use, including models without native function-calling support.",
                listOf(
                    ...
                    "Stopping generation cancels the active provider request and rejects any pending Chat-only approval.",
                     "Chat has its own Stop control; it cancels only the active Chat generation and any agent task owned by that Chat turn.",
                     "Each Agent task has its own Stop control; stopping an agent cancels only that selected agent and does not stop Chat or other agents.",
    ...
    GuideCategory(
        ...
        listOf(
            ...
            t("Delete GitHub repository","Permanently delete a selected GitHub repository without leaving DevForge.",
                listOf("Open Build Center → GitHub repository.","Select a repository.","Tap Delete repository.","Type the exact repository name.","Confirm Delete permanently."),
                "Build Center → GitHub repository → repository details.",
                listOf("exact name = required confirmation","delete = permanent remote operation")),
    ...
    GuideCategory(
        ...
        listOf(
            ...
            t("Agent durability","Agent task records can survive process recreation within the supported persistence limits.",
                listOf("Start a task.","Leave and return later.","Inspect the task state before continuing."),
                "Agent task center."),
        ),
    ),
    GuideCategory(
        ...
        listOf(
            t("File attachments","Attach supported files to features that accept them.",
                listOf("Tap the attachment control.","Choose the file.","Review the attached item before sending."),
                "Chat/file attachment controls.",
                listOf("paperclip/file = attachment")),
            t("Images/media","Use supported image/media selection where the target feature accepts it.",
                listOf("Open the attachment picker.","Choose an item.","Review the preview."),
                "Attachment picker."),
    ...
    GuideCategory(
        ...
        listOf(
            ...
            t("AI Run Inspector","Inspect durable agent task state without opening the main Agents surface.",
                listOf("Open DevForge Center → AI Run Inspector.","Select a task.","Review status, instruction, provider, model, step, last tool, approval, errors and result."),
