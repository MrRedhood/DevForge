...
private val guideCategories = listOf(
    ...
    GuideCategory(
        ...
        listOf(
            ...
            t("AI-managed agent runs","AI can deploy bounded coding agents automatically when a request benefits from parallel or specialized work. There is no user-facing agent launcher.",
                listOf("Ask DevForge AI for a coding change.","AI creates an ordered plan and may deploy multiple agents.","Watch their provider, model, elapsed time, current step and tool activity.","After completion, review the agent overview and changed paths."),
                "AI Chat → live agent run panel; More → DevForge Center → AI Run Inspector.",
                listOf("user = observer","AI = agent orchestrator","agents stop automatically when their task reaches a terminal state")),
