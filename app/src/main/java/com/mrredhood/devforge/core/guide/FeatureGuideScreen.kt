    ...
    GuideCategory(
        ...
        listOf(
            ...
            t("File preview","Open a workspace file in the editor.",
                ...
                "Workspace tree."),
            t("Web Live Preview","Open a workspace file directly in the Web Live Preview surface with workspace-relative HTML/CSS/JavaScript assets served by the web runtime.",
                listOf(
                    ...
                    "Tapping ▶ Preview from the Editor adopts the current active editor file, while a file chosen inside Live Preview remains independent until the next explicit Preview launch or chooser selection.",
                    ...
                    "When a GitHub-backed file has an unsynced DevForge change, Live Preview uses the pending/current content before falling back to the repository version, so newly created or edited files can be previewed before commit.",
                    ...
                    "If you switch to another editor file, the open Live Preview keeps its selected target until you explicitly relaunch Preview or choose another file.",
                ),
                "Editor → ▶ Preview; choose the file from the Live Preview chooser.",
