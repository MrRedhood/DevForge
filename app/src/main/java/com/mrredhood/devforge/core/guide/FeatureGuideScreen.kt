    ...
    GuideCategory(
        ...
        listOf(
            ...
            t("Tabs","Keep multiple files open.",
                ...
                "Editor tab strip.",
                listOf("● = dirty","× = close")),
            t("Refresh file","Reload the active file from the current workspace without closing the tab, including changes made by AI or another workspace editor.",
                listOf("Tap Refresh in the Editor top bar or editor toolbar.","Clean files reload immediately from the active workspace.","Dirty files show a confirmation before unsaved content is replaced.","After a successful refresh, the old recovery draft is cleared so reopening the file uses the refreshed content."),
            ...
            t("AI Mission","AI Chat shows a model-generated plan only when the model decides a multi-step task needs one.",
                ...
                listOf("AI's plan = model-generated action summary","live status = current execution state","no plan = simple task")),
