...
- AI plan and execution workflow with plan → inspect → execute → verify → review, compact activity timeline and durable recovery
...
- AI execution summaries with observed paths, write/delete/command counts, and Build Center-backed build verification
